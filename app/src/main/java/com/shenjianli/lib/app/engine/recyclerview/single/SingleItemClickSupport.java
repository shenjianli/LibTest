package com.shenjianli.lib.app.engine.recyclerview.single;
...
public class SingleItemClickSupport {
    ...
    private SingleItemClickSupport(RecyclerView recyclerView) {
        ...
        mRecyclerView.setTag(com.shenjianli.shenlib.R.id.item_click_support, this);
        mRecyclerView.addOnChildAttachStateChangeListener(mAttachListener);
    }

    public static SingleItemClickSupport addTo(RecyclerView view) {
        SingleItemClickSupport support = (SingleItemClickSupport) view.getTag(com.shenjianli.shenlib.R.id.item_click_support);
        if (support == null) {
    ...
    private void detach(RecyclerView view) {
        ...
        view.setTag(com.shenjianli.shenlib.R.id.item_click_support, null);
    }
